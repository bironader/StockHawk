...
public class StockProvider extends ContentProvider {
    ...
    private static UriMatcher buildUriMatcher() {
        ...
        matcher.addURI(Contract.AUTHORITY, Contract.PATH_QUOTE, QUOTE); // com.udacity.stockhawk, qoute , 100
        matcher.addURI(Contract.AUTHORITY, Contract.PATH_QUOTE_WITH_SYMBOL, QUOTE_FOR_SYMBOL); // com.udacity.stockhawk ,quote/*,101
        return matcher;
    }
